///////////////////////////////////////////////////////////////////////
//             AUTOGENERATED 2018-09-19 00:15:02.101872              //
...
namespace GlmNet
{
        ...
        : ivec<vec2>
    {
        ...
        /// <inheritdoc />
        public vec2 Add(vec2 second) => this + second;

        /// <inheritdoc />
        public vec2 Negate(vec2 second) => -this;

        /// <inheritdoc />
        public vec2 Subtract(vec2 second) => this - second;

        /// <inheritdoc />
        public vec2 Multiply(vec2 second) => this * second;

        /// <inheritdoc />
        public vec2 Multiply(scalar factor) => this * factor;
        ...
        : ivec<vec3>
    {
        ...
        /// <inheritdoc />
        public vec3 Add(vec3 second) => this + second;

        /// <inheritdoc />
        public vec3 Negate(vec3 second) => -this;

        /// <inheritdoc />
        public vec3 Subtract(vec3 second) => this - second;

        /// <inheritdoc />
        public vec3 Multiply(vec3 second) => this * second;

        /// <inheritdoc />
        public vec3 Multiply(scalar factor) => this * factor;
        ...
        : ivec<vec4>
    {
        ...
        /// <inheritdoc />
        public vec4 Add(vec4 second) => this + second;

        /// <inheritdoc />
        public vec4 Negate(vec4 second) => -this;

        /// <inheritdoc />
        public vec4 Subtract(vec4 second) => this - second;

        /// <inheritdoc />
        public vec4 Multiply(vec4 second) => this * second;

        /// <inheritdoc />
        public vec4 Multiply(scalar factor) => this * factor;
        ...
        : ivec<vec5>
    {
        ...
        /// <inheritdoc />
        public vec5 Add(vec5 second) => this + second;

        /// <inheritdoc />
        public vec5 Negate(vec5 second) => -this;

        /// <inheritdoc />
        public vec5 Subtract(vec5 second) => this - second;

        /// <inheritdoc />
        public vec5 Multiply(vec5 second) => this * second;

        /// <inheritdoc />
        public vec5 Multiply(scalar factor) => this * factor;
        ...
        : ivec<vec6>
    {
        ...
        /// <inheritdoc />
        public vec6 Add(vec6 second) => this + second;

        /// <inheritdoc />
        public vec6 Negate(vec6 second) => -this;

        /// <inheritdoc />
        public vec6 Subtract(vec6 second) => this - second;

        /// <inheritdoc />
        public vec6 Multiply(vec6 second) => this * second;

        /// <inheritdoc />
        public vec6 Multiply(scalar factor) => this * factor;
        ...
        : ivec<vec7>
    {
        ...
        /// <inheritdoc />
        public vec7 Add(vec7 second) => this + second;

        /// <inheritdoc />
        public vec7 Negate(vec7 second) => -this;

        /// <inheritdoc />
        public vec7 Subtract(vec7 second) => this - second;

        /// <inheritdoc />
        public vec7 Multiply(vec7 second) => this * second;

        /// <inheritdoc />
        public vec7 Multiply(scalar factor) => this * factor;
        ...
        : ivec<vec8>
    {
        ...
        /// <inheritdoc />
        public vec8 Add(vec8 second) => this + second;

        /// <inheritdoc />
        public vec8 Negate(vec8 second) => -this;

        /// <inheritdoc />
        public vec8 Subtract(vec8 second) => this - second;

        /// <inheritdoc />
        public vec8 Multiply(vec8 second) => this * second;

        /// <inheritdoc />
        public vec8 Multiply(scalar factor) => this * factor;
        ...
        : ivec<vec9>
    {
        ...
        /// <inheritdoc />
        public vec9 Add(vec9 second) => this + second;

        /// <inheritdoc />
        public vec9 Negate(vec9 second) => -this;

        /// <inheritdoc />
        public vec9 Subtract(vec9 second) => this - second;

        /// <inheritdoc />
        public vec9 Multiply(vec9 second) => this * second;

        /// <inheritdoc />
        public vec9 Multiply(scalar factor) => this * factor;
        ...
        : ivec<vec10>
    {
        ...
        /// <inheritdoc />
        public vec10 Add(vec10 second) => this + second;

        /// <inheritdoc />
        public vec10 Negate(vec10 second) => -this;

        /// <inheritdoc />
        public vec10 Subtract(vec10 second) => this - second;

        /// <inheritdoc />
        public vec10 Multiply(vec10 second) => this * second;

        /// <inheritdoc />
        public vec10 Multiply(scalar factor) => this * factor;
